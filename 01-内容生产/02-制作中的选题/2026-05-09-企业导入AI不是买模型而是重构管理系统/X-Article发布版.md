...
![封面：企业不是缺模型，是流程还不能被 AI 接管](images/01-hero-ai-ready-operating-system.png)
...
![框架图：AI Ready 五要素](images/02-framework-ai-ready-five-layers.png)
...
| 维度 | 关键问题 | AI Ready 状态 |
| --- | --- | --- |
| 数据位置 | 数据在哪里？ | 有数据地图 / 数据目录 |
| 数据归属 | 谁负责？ | 每类数据有 owner |
| 数据结构 | AI 看得懂吗？ | 有标准字段、标签、元数据 |
| 数据权限 | 谁能看？ | RBAC / ABAC / 分级授权 |
| 数据质量 | 准不准？ | 有质量检测和更新机制 |
| 数据语义 | 知道含义吗？ | 有业务 ontology / 数据字典 |
...
![评分卡：100 分 AI Readiness 诊断](images/03-scorecard-ai-readiness.png)
...
![路线图：从 1-3 个流程到企业级 Agent OS](images/04-roadmap-agent-os.png)
