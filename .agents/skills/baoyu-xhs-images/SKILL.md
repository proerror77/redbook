...
| Style | Description |
|-------|-------------|
| `cute` | Sweet, adorable, girly - classic Xiaohongshu aesthetic |
| `fresh` | Clean, refreshing, natural |
| `warm` | Cozy, friendly, approachable |
| `bold` | High impact, attention-grabbing |
| `minimal` (Workspace Default) | Ultra-clean, sophisticated, simple/elegant article card aesthetic |
...
| AI, product, agent, business, elegant, simple | `minimal` | sparse/balanced |
