...
生成封面或系列配图时，不要每张图从零写一个全新 prompt。先建立可复用视觉配方：

- 汤底 / Base broth：本账号稳定的视觉判断。默认是苹果式克制、手机端可读、明确层级、少而准的文字、足够留白、观点服务优先。
- 佐料 / Style seasoning：本次内容的可替换风格模块，例如建筑图纸美学、产品手册美学、电影片头美学、东方文人美学、艺术展览美学、园艺手账美学、综艺预告美学。
- 变量 / Content variables：每次变化的标题、对象、核心判断、读者任务、平台比例和少量视觉元素。

工作流要求：

1. 先理解对象为什么值得被看见，再决定图像，不把用户输入直接排版。
2. 一个内容包只选择 1 个主佐料，最多 1 个辅助佐料；不要混合 4-5 种风格词。
...
| 佐料 | 适合内容 | 可执行约束 |
| --- | --- | --- |
| 建筑图纸美学 | 系统、workflow、权限、架构 | 中轴网格、细线结构、石墨灰强调、工程注释感，避免假坐标和小字过密 |
| 产品手册美学 | 工具、方法、产品说明 | 干净分区、组件爆炸图、蓝/墨色强调、步骤关系清楚 |
| 电影片头美学 | 迁移、转折、风险、趋势判断 | 宽银幕留白、暗金点缀、慢进入情绪、少量线索字 |
| 东方文人美学 | 反思、长期主义、审美判断 | 大留白、题跋式短字、朱砂点缀、克制抽象 |
| 艺术展览美学 | 观点、概念、抽象判断 | 展墙说明式呼吸感、雾紫/灰调、小字只作氛围 |
| 园艺手账美学 | 养成、流程维护、长期运营 | 日期/天气式轻标注、鼠尾草绿、生活化小插画 |
| 综艺预告美学 | 轻松吐槽、反差、爆梗 | 明亮高对比、贴纸小字、圆润字体；仅用于轻内容，不用于企业严肃主题 |
...
- Base broth：账号固定视觉底层，例如克制、高级、手机可读、少文字、观点服务优先。
- Style seasoning：本图采用的 1 个主佐料，以及它如何影响网格、字体、色彩、点缀和插画。
