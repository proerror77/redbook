...
cli({
  site: 'boss',
  name: 'send-resume',
  description: 'BOSS直聘向指定会话触发发送简历按钮',
  ...
  args: [
    ...
    { name: 'dry_run', type: 'bool', default: false, help: 'Preview the resume-send action without clicking the button' },
  ],
  ...
  func: async (page: IPage | null, kwargs) => {
    ...
    const result = await chatBrowser.sendResumeFromActiveConversation(adapter, {
