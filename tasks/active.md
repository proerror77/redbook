...
- [x] Repair the Userscript card-location fallback so visible Shanghai cards are not rejected when BOSS changes the location CSS class; verify with a focused regression.
