...
- **Aspect Ratio**: 3:4
- **Style**: Simple elegant editorial card, unless the selected preset explicitly requires another style

## Core Principles

- Simple, elegant visual quality throughout; avoid loud poster effects
- Prefer off-white / graphite / ink / soft gray with one accent color for article cards
...
- Text should be clean, readable, and restrained
- Main titles should be prominent without looking loud
- Key text should be bold and enlarged
- Use highlighter effects to emphasize keywords
- Do not use tiny text, warped text, noisy decorations, fake logos, glossy 3D blobs, bokeh, or generic AI glow
...
Use the Tuzi image-generation route with model `gpt-image-2.0` to generate the infographic based on the specifications above.
```
